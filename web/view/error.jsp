<%-- 
    Document   : error
    Created on : Aug 14, 2014, 3:21:30 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        <header>
            <div class="container">
            <a class="pull-left" href="index.html" id="logo">
                <h1>Music ON Web</h1>
                <h2>Beat Drops</h2>
            </a>
       ...
       <form method="post" action="login.do">
          ...
          <p style="padding-left: 15px;">Don't have an account? <a href="#">Sign UP</a></p>
          <p class="c error">Invalid ID or Password</p>
       </form>
      </div>          
      </ul>   
      </aside>
